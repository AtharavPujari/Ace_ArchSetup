...
hl.bind("SUPER + SHIFT + mouse_down", fn.move_active_window("-1", true))
hl.bind("SUPER + SHIFT + mouse_up", fn.move_active_window("+1", true))
hl.bind("SUPER + ALT + mouse_down", fn.move_active_window("-1", true))
hl.bind("SUPER + ALT + mouse_up", fn.move_active_window("+1", true))
hl.bind("SUPER + ALT + Page_Up", fn.move_active_window("-1", true), { repeating = true })
hl.bind("SUPER + ALT + Page_Down", fn.move_active_window("+1", true), { repeating = true })
hl.bind("CTRL + SUPER + SHIFT + right", fn.move_active_window("+1", true), { repeating = true })
hl.bind("CTRL + SUPER + SHIFT + left", fn.move_active_window("-1", true), { repeating = true })
